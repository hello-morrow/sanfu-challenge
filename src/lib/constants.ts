...
// ── EXP System ──
export const EXP_PER_MISSION = 20;
export const EXP_THRESHOLDS = [0, 100, 250, 500, 800, 1200, 1700, 2300, 3000, 4000,
  ...
  36000, 43000, 51000, 60000, 70000, 81000, 93000, 106000, 120000, 135000,
  151000, 168000, 186000, 205000, 225000, 246000, 268000, 291000, 315000, 340000,
];
