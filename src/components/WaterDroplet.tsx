...
export default function WaterDroplet({
  ...
  const maxDrops = WATER_GOAL / WATER_STEP; // 8 drops

  return (
    <div className="space-y-3">
      <div className="flex items-center justify-between text-sm">
        <span className="text-text-secondary">今日饮水</span>
          ...
          <button
            ...
            className={`w-8 h-8 rounded-full flex items-center justify-center transition-all ${
              i < drops
                ...
                : "bg-green-pale text-green-primary border border-green-light"
            }`}
          >
            ...
            <span className="sr-only">{WATER_STEP}ml</span>
          </button>
        ))}
      </div>
    </div>
